...
( function( window, undefined ) {
    ...
    window.brytescore.authenticate = function( userID, userName, userEmail ) {
    ...
    // start a pageView
    window.brytescore.pageview = function( campaign, campaignMedium, campaignSource) {
        ...
        window.brytescore.track( 'pageview', pageViewData);
        window.setInterval( function() {
            brytescore.startHeartBeat();
        }, 15000 );
    }
	...
	window.brytescore.track = function () {
        ...
        sendRequest( 'track', eventName, args );
	};

    window.brytescore.startHeartBeat = function () {
	...
	brytescore.init();
//    brytescore.setAPIKey( 'kensAPIKey' );
//    brytescore.authenticate( 'someUserID', 'Ken Sanders', 'ken@brytecore.com' );
